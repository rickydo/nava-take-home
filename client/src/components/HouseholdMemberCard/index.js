...
const HouseholdMemberCard = ({ id, first_name, last_name, description, favorite_fruit }) => {
  return <article className="card ds-u-radius ds-u-padding--2 ds-u-border--1 ds-u-margin--1">
    ...
    <p><label className="ds-u-font-weight--bold ds-u-margin-right--1">Description: </label>{description}</p>
    <p><label className="ds-u-font-weight--bold ds-u-margin-right--1">Favorite fruit: </label>{favorite_fruit}</p>
  </article>
}
